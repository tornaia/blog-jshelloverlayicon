...
namespace JShellOverlayIcon
{
    ...
    public class MyCloud1SyncedOverlayIcon : AbstractOverlayIcon
    {
    ...
    public class MyCloud2SyncingOverlayIcon : AbstractOverlayIcon
    {
    ...
    public class MyCloud3IgnoredOverlayIcon : AbstractOverlayIcon
    {
    ...
    public class MyCloud4UnsyncedOverlayIcon : AbstractOverlayIcon
    {
